...
1 - Find the first node of loop in linked list
...
1 - Check if it is possible to survive on Island

Day 71 ---------------------------------------------------------------------------------------

1 - Maximize sum(arr[i]*i) of an Array
...
1 - String in lexicographically-sorted order
...
1 - First Element to Occur K times in an array
